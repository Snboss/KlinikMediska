...
class AdministrasiController extends Controller
{
    ...
    public function create()
    {
        ...
        $data['list_obat'] = \App\Models\Obat::get();
    ...
    public function store(Request $request)
    {
        ...
        $totalBiaya = $poli->biaya + $biayaTambahan + $obat->harga_jual;
        $adm = new \App\Models\Administrasi();
        $adm->kode_administrasi = $kode;
        $adm->poli = $poli->nama;
        $adm->nama_obat = $obat->nama_obat;
        ...
        $adm->obat = $obat->harga_jual;
        $adm->biaya_tambahan = $biayaTambahan;
        $adm->total_biaya = $totalBiaya;
        $adm->save();
    ...
    public function edit(string $id)
    {
        ...
        $data['list_obat'] = \App\Models\Obat::selectRaw("id, concat(kode_obat, ' - ', harga_jual) as tampil")->pluck('tampil', 'id');
