            ...
            <form action="/user/<?php echo e($user->id); ?>" method="POST">
                ...
                <div class="form-group mt-1">
                    ...
                    <select name="role" class="form-control">
                        <option value="operator" <?php if($user->role == 'operator'): echo 'selected'; endif; ?>> Operator</option>
...
<?php echo $__env->make('layouts.sbadmin2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\tegar\Documents\2024\rian\klinik-app\resources\views/user_edit.blade.php ENDPATH**/ ?>