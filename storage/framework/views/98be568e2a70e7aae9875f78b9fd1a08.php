...
<body>
    ...
    <div id="topbar" class="d-flex align-items-center fixed-top">
        <div class="container d-flex justify-content-between">
            <div class="contact-info d-flex align-items-center">
                ...
                <i class="bi bi-phone"></i> +628123456789
            </div>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="index.html">E-Klinik Mediska Padang</a></h1>
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="#departments">Bagian</a></li>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container">
            <h1>Selamat Datang Di E-Klinik Mediska Padang</h1>
            <h2>Memberi Kemudahan Untuk Semua</h2>
    ...
    <main id="main">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 d-flex align-items-stretch">
                        <div class="content">
                            <h3>Kenapa Memilih Klinik Mediska Padang?</h3>
                            <p>
                                Klinik Mediska Padang menawarkan pelayanan medis terbaik dengan teknologi terkini,
                                menjadikan kami klinik terpercaya untuk kesehatan Anda dan keluarga.
                                 Komitmen kami adalah keamanan, kenyamanan, dan kepuasan pasien.
                                 Didukung oleh dokter-dokter berpengalaman yang siap membantu Anda,
                                 kami menyediakan layanan terpadu mulai dari pencatatan rekam medis hingga perawatan terapi.
                            </p>
                            ...
                            <div class="row">
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="icon-box mt-4 mt-xl-0">
                                        ...
                                        <h4></h4>
                                        <p>Nikmati kemudahan reservasi online yang cepat dan praktis,
                                            dirancang untuk kenyamanan Anda. Klinik kami berlokasi strategis dengan akses mudah,
                                            dilengkapi fasilitas modern untuk pengalaman berobat yang menyenangkan.
                                             Perhatian khusus kami berikan untuk setiap detail kesehatan Anda,
                                            memastikan Anda mendapatkan perawatan terbaik.</p>
                                    </div>
                                </div>
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="icon-box mt-4 mt-xl-0">
                                        ...
                                        <h4>Sudah Saatnya.</h4>
                                        <p>Hubungi kami sekarang untuk konsultasi gratis dan rasakan pelayanan medis yang berbeda di Klinik Mediska Padang.</p>
                                    </div>
                                </div>
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="icon-box mt-4 mt-xl-0">
                                        ...
                                        <h4>Tentang Kami</h4>
                                        <p>Pengunjung Bisa Melihat E-klinik Mediska Padang</p>
                                    </div>
                                </div>
                            </div>
                        </div><!-- End .content-->
        ...
        <section id="services" class="services">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>Layanan Poli</h2>
                    <p>Setiap poli kami dilengkapi dengan dokter-dokter berpengalaman yang siap membantu Anda. Dari poli umum hingga spesialis, kami menyediakan layanan terpadu mulai dari pencatatan rekam medis hingga perawatan terapi.
                    ...
                    <?php $__currentLoopData = $poli; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                            <div class="icon-box">
                                ...
                                <h4><a href="">Poli <?php echo e($item->nama); ?></a></h4>
        ...
        <section id="doctors" class="doctors">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>Dokter</h2>
                    <p>Setiap dokter di Klinik Mediska Padang siap memberikan perhatian khusus pada setiap detail kesehatan Anda. Dari konsultasi hingga perawatan, dokter kami akan memastikan Anda mendapatkan perawatan yang tepat dan efektif. Kami menyediakan layanan terpadu mulai dari pencatatan rekam medis hingga perawatan terapi, semua dilakukan oleh tenaga medis profesional..</p>
                </div>
                                ...
                                <div class="pic">
                                    <?php if($item->foto == null): ?>
                                        <img class="img-fluid" src="/medilab/assets/img/doctors/doctors-1.jpg"
                                            alt="">
                                    <?php else: ?>
                                        <img src="<?php echo e(Storage::url($item->foto)); ?>" class="img-fluid" alt="">
                                    <?php endif; ?>
                                </div>
                                <div class="member-info">
                                    <h4><?php echo e($item->nama_dokter); ?></h4>
                                    <span>Spesialis <?php echo e($item->spesialis); ?></span>
                                    <p>Explicabo voluptatem mollitia et repellat qui dolorum quasi</p>
                                    <div class="social">
                                        <a href="<?php echo e($item->twitter); ?>"><i class="ri-twitter-fill"></i></a>
                                        <a href="<?php echo e($item->facebook); ?>"><i class="ri-facebook-fill"></i></a>
                                        <a href="<?php echo e($item->instagram); ?>"><i class="ri-instagram-fill"></i></a>
                                        <a href="<?php echo e($item->tiktok); ?>"> <i class="ri-tiktok-fill"></i> </a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section id="appointment" class="appointment section-bg">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>RESERVASI PASIEN</h2>
                    <p>Dengan sistem registrasi online kami, Anda dapat mendaftar dari kenyamanan rumah Anda sendiri, memilih jadwal yang sesuai, dan menghindari antrean panjang. Setiap pasien mendapatkan perhatian khusus dari dokter-dokter berpengalaman kami, yang siap membantu Anda dengan layanan terpadu mulai dari pencatatan rekam medis hingga perawatan terapi.</p>
                </div>
        ...
        <section id="faq" class="faq section-bg">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>Kamu Punya Pertanyaan?</h2>
                    <p>Ayo hubungi kami pada link dibawah !!</p>
                </div>
...
<?php /**PATH C:\Users\tegar\Documents\2024\rian\klinik-app\resources\views/layouts/medilab.blade.php ENDPATH**/ ?>