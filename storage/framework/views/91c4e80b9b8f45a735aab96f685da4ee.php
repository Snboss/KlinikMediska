            ...
            <form action="/pasien" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6 form-group ">
                        ...
                        <input type="text" name="nama_pasien" class="form-control" value="<?php echo e(old('nama_pasien')); ?>"
                            autofocus />
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-check ml-3">
                            <input type="radio" name="jenis_kelamin" value="Laki-laki" class="form-check-input"
                                id="lk" <?php echo e(old('jenis_kelamin') == 'Laki-laki' ? 'checked' : ''); ?>>
                        ...
                        <div class="form-check ml-3">
                            <input type="radio" name="jenis_kelamin" value="Perempuan" class="form-check-input"
                                id="pr" <?php echo e(old('jenis_kelamin') == 'Perempuan' ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.sbadmin2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\tegar\Documents\2024\rian\klinik-app\resources\views/pasien_create.blade.php ENDPATH**/ ?>