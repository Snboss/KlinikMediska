...
@section('content')
    ...
    {{--  <div class="card">
        <div class="card-header">
            LAPORAN DATA ADMINISTRASI PER TAHUN
        </div>
        <div class="card-body">
            <form action="/laporan/administrasi" method="GET" target="_blank">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="tahun_awal" name="tahun_awal"
                            value="{{ now()->subMonth(1)->format('Y-m-d') }}">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="tahun_akhir">Tahun Akhir</label>
                        <input type="text" class="form-control" id="tahun_akhir" name="tahun_akhir"
                            value="{{ now()->format('Y') }}">
                    </div>
                </div>
                <button type="submit" class="btn btn-primary">Generate Laporan</button>
