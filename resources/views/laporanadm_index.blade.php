...
<body style="background: white;">
    <div class="container-fluid">
        <div class="col-md-12">
            ...
            <div class="text-center">Tanggal Laporan : {{ request('tanggal_awal') }} - {{ request('tanggal_akhir') }}</div>
                    ...
                    <tbody>
                        @foreach ($adm as $item)
                            <tr>
                                ...
                                <td>
                                    <span class="badge badge-pill badge-{{ $item->status == 'baru' ? 'primary' : 'success' }}"
